...
class RoomDaoTest {
    ...
    private fun book(id: String, stream: String) = BookEntity(id, id, null, stream, "mathematics", null, null, "https://example.invalid/$id", "a".repeat(64), null, "en", null, 1)

    @Test fun compositeSubjectLookupSeparatesStreams() {
    ...
    @Test fun bookDeleteCascadesBookmarksAndProgress() {
